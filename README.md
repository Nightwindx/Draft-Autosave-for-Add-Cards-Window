# **Draft Autosave for Add Cards Window (Anki Add-on)**
...
A draft is removed **only when a note is successfully added**.

Drafts are *not* deleted when:

* You close the Add window
...
Pull requests and improvements are welcome — especially for:

* UI notifications (“Draft restored” message)
